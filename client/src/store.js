...
export const useStore = create((set, get) => ({
  ...
  logout: () => set(() => { localStorage.removeItem('token'); localStorage.removeItem('user'); return { user: null, token: null, conversations: [], activeId: null, messages: {}, leftTab: 'direct', profileOpen: false, unreadCounts: {}, notifications: [] } }),
  profileOpen: false,
